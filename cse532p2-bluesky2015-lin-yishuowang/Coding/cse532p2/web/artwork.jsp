...
/****************************************************************************
CSE532 -- Project 2
File name:  Artwork.jsp
Author(s):  Minghui Lin (109557872)
            Yishuo Wang (108533945)
Brief description: Select all data from Artwork Table
...
<html>
    ...
    <% 
        ...
        String sqlstr = "SELECT * FROM public.\"Artwork\" ORDER BY \"AId\" ASC";
    ...
    <% 
        ...
        try {
            ...
            // OUTPUT TABLE HEADER
            out.println("<table>");
            out.println("<caption>Artwork Table</caption>");
            out.println("<tr><th>AId</th><th>Name</th></tr>");
