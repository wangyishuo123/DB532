...
Brief description: Select all data from Show Table
...
<html>
    ...
    <% 
        ...
        String sqlstr = "SELECT * FROM public.\"Show\" ORDER BY \"SId\" ASC";
    ...
    <% 
        ...
        try {
            ...
            // OUTPUT TABLE HEADER
            out.println("<table>");
            out.println("<caption>Show Table</caption>");
            out.println("<tr><th>SId</th><th>Name</th></tr>");

            // OUTPUT TABLE DATA
            while(rs.next()) {
                String CId = rs.getString(1);
                String Date = rs.getString(2);
                out.println("<tr><th>"+CId + "</th><th>" + Date +"</th></tr>");
            }
