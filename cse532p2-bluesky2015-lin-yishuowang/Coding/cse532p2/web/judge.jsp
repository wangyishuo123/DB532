...
Brief description: Select all data from Judge Table
...
<html>
    ...
    <% 
        ...
        String sqlstr = "SELECT * FROM public.\"Judge\" ORDER BY \"JId\" ASC";
    ...
    <% 
        ...
        try {
            ...
            // OUTPUT TABLE HEADER
            out.println("<table>");
            out.println("<caption>Judge Table</caption>");
            out.println("<tr><th>JId</th><th>Name</th></tr>");
